function App() {
  return (
    <div className="container mx-auto">
      <header className="header flex justify-between py-6 items-center">
        ...
        <div className="menu flex items-center">
          <ul className="list-none flex font-bold mr-3">
            <li className="text-blue-600 px-4 cursor-pointer hover:text-blue-600">Home</li>
            <li className="text-blue-800 px-4 cursor-pointer hover:text-blue-600">About</li>
      ...
      <main>
        <div className="flex items-center py-48">
          <div className="w-1/2 px-20">
            <div className="font-bold text-blue-900 animate__animated animate__slideInUp" style={{ fontSize: 48, lineHeight: '57px' }}>
          ...
          <div className="w-1/2 px-20 animate__animated animate__slow animate__zoomIn">
